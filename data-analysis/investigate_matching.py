...
print("=" * 70)
bank = pd.read_csv(r"C:\Projects\cmtaccounting\relevant-data\MRS\2023\01. Jan. 2023\PSPs\TrustPayments.csv", nrows=3)
...
print("=" * 70)
crm = pd.read_excel(r"C:\Projects\cmtaccounting\relevant-data\MRS\2023\01. Jan. 2023\platform\CRM Transactions Additional info.xlsx", nrows=3)
...
print("=" * 70)
dw = pd.read_csv(r"C:\Projects\cmtaccounting\relevant-data\MRS\2023\01. Jan. 2023\platform\Deposit and Withdrawal Report.csv", nrows=3)
...
print("=" * 70)
output = pd.read_excel(r"C:\Projects\cmtaccounting\relevant-data\Life cycle report\2023\1. January\List.xlsx", nrows=3)
...
print("=" * 70)
output_full = pd.read_excel(r"C:\Projects\cmtaccounting\relevant-data\Life cycle report\2023\1. January\List.xlsx")
# Check if Deal No values exist in the CRM file
crm_full = pd.read_excel(r"C:\Projects\cmtaccounting\relevant-data\MRS\2023\01. Jan. 2023\platform\CRM Transactions Additional info.xlsx")
dw_full = pd.read_csv(r"C:\Projects\cmtaccounting\relevant-data\MRS\2023\01. Jan. 2023\platform\Deposit and Withdrawal Report.csv")
...
bank_full = pd.read_csv(r"C:\Projects\cmtaccounting\relevant-data\MRS\2023\01. Jan. 2023\PSPs\TrustPayments.csv")
